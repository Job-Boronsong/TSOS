export default function Slide05Modules() {
  return (
    ...
    >
      <div style={{ position: "absolute", top: "-5vh", right: "-5vw", width: "40vw", height: "40vw", borderRadius: "50%", background: "radial-gradient(circle, rgba(124,107,240,0.12) 0%, rgba(124,107,240,0) 70%)" }} />

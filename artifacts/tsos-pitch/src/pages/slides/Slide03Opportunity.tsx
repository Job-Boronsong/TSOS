...
export default function Slide03Opportunity() {
  return (
    ...
    >
      <div style={{ position: "absolute", top: "10vh", left: "25vw", width: "45vw", height: "45vw", borderRadius: "50%", background: "radial-gradient(circle, rgba(124,107,240,0.14) 0%, rgba(124,107,240,0) 70%)" }} />
